...
const AboutSection = () => {
  ...
  const renderQuotes = (): React.ReactNode => (
    <h1 ref={quoteRef} className="font-medium text-3xl sm:text-4xl md:text-6xl">
      ...
      >
        I am a full-stack developer with a strong emphasis on scalable, production-grade code{" "}
      </span>
      <span
      ...
      >
        I am committed to creating exceptional user experiences through modern frontend architecture.
      </span>
    </h1>
  );
